...
public class SemesterResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/semesters/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<Semester> partialUpdateSemester(
        ...
        Optional<Semester> result = semesterRepository
            ...
            .map(
                existingSemester -> {
                    ...
                    if (semester.getDescription() != null) {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, semester.getId().toString())
        );
    }
